...
const NewsCard = ({ news, navigate, handleShareClick, handleSubscribeClick }) => (
  <Grid item xs={12} sm={6} md={4} key={news.id}>
    ...
    <CardActions>
      ...
      />
      <ShareIcon onClick={() => handleShareClick(news)} />
    </CardActions>
  </Grid>
);
...
const handleShareClick = async (news) => {
  ...
  if (navigator.share) {
    ...
    // Fallback method for browsers that do not support Web Share API
      ...
      >
        {loading ?
          ...
          <Box sx={{ justifyContent: "center", margin: "auto", alignItems: "center", textAlign: "center", marginTop: "5rem" }}>
            ...
            >
              If it taking time kindly checky your Net Work Connection
            </Typography>
          </Box> : (
            <>
              {posts
                .filter(news => news.category === "Bussiness")
